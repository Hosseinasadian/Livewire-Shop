<aside class="left-sidebar" data-sidebarbg="skin6">
    ...
    <!-- Sidebar scroll-->
    <div class="sidebar-nav scroll-sidebar" data-simplebar>
        <!-- Sidebar navigation-->
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="{{route('admin.template.index')}}" aria-expanded="false">
                        <i class="ti ti-cpu"></i>
                        <span class="hide-menu">@lang('Templates')</span>
                    </a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a href="{{route('admin.template.index')}}" class="sidebar-link">
                                ...
                                <span class="hide-menu">@lang('list')</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{route('admin.template.create')}}" class="sidebar-link">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-circle"></i>
                                </div>
                                <span class="hide-menu">@lang('create')</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
                                            aria-expanded="false"><i data-feather="grid"
                                                                     class="feather-icon"></i><span
                ...
                <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
                                            aria-expanded="false"><i data-feather="box"
                                                                     class="feather-icon"></i><span
                ...
                <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="authentication-login1.html"
                                            aria-expanded="false"><i data-feather="lock"
                                                                     class="feather-icon"></i><span
